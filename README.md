...
* **Hospital Management System** (Teamwork)
    * Contributed to the development of a robust hospital management system using JavaScript for backend development and HTML/CSS for front-end.
...
* LinkedIn: www.linkedin.com/in/tushartak/
